# Contributing to `linmo`

:+1::tada: First off, thanks for taking the time to contribute! :tada::+1:

The following is a set of guidelines for contributing to [linmo](https://github.com/sysprog21/linmo)
...
Visit our [Issues page on GitHub](https://github.com/sysprog21/linmo/issues) to search and submit.
